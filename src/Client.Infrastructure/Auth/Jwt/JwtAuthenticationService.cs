...
public class JwtAuthenticationService : AuthenticationStateProvider, IAuthenticationService, IAccessTokenProvider
{
    ...
    public async ValueTask<AccessTokenResult> RequestAccessToken()
    {
        ...
        {
            return new AccessTokenResult(AccessTokenResultStatus.RequiresRedirect, null, "/login", new InteractiveRequestOptions());
        }
        ...
        try
        {
            ...
            return new AccessTokenResult(AccessTokenResultStatus.Success, new AccessToken() { Value = token }, string.Empty, new InteractiveRequestOptions());
        }
        finally
        {
            _semaphore.Release();
